...
// Exported button function
export function createUniversalPaymentButton(paymentParams: BlinkParams): HTMLButtonElement {
  const button = document.createElement('button');
  button.textContent = '🚀 Open Any Wallet';
  ...
  button.addEventListener('click', async () => {
    ...
    statusDiv.textContent = `Opening best wallet...`;
    ...
    // Optional: append status if it doesn't exist
